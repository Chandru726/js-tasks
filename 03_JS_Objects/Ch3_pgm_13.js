...
// Step 2: In the console, type `geolocation.city` and press Enter

// Step 3: In the console, type `geolocation` and press Enter

// The following lines are for demonstration purposes to show the properties
